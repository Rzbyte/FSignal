...
<title>FSignal</title>
<style>
body{{font-family:Inter,system-ui;background:#0b0d10;color:#f6f7f9;padding:40px}}
main{{max-width:1100px;margin:auto}}h1{{font-size:44px}}
.cards{{display:grid;grid-template-columns:repeat(4,1fr);gap:14px}}
.c{{background:#151920;border:1px solid #262c36;border-radius:16px;padding:20px}}
.n{{font-size:34px;font-weight:800}}table{{width:100%;margin-top:24px;border-collapse:collapse}}
td,th{{padding:13px;border-bottom:1px solid #2b313b;text-align:left}}a{{color:#8ab4ff}}
</style>
<main>
<h1>FSignal</h1>
